...
Fora do Notion, os agentes desta equipe também leem `Segundo Cérebro/Voz/Voz.md`
...
2. **Acesso a `Arquivos/` e `Segundo Cérebro/`:** confirmado, são pastas irmãs de `conteudo/`, sem barreira de
   acesso.
