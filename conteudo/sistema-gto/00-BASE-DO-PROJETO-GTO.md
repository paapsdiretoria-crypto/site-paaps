...
2. **Acesso a `wiki/`** (irmã de `conteudo/` dentro de SITE PAAPS). É onde vivem
   `voz-paaps.md`, `identidade-aplicada.md`, `visual-instagram.md`, `mapa-fontes-foto.md` (em
   `wiki/voz-e-identidade/`) e a base teórica da Tecelã (`wiki/base-teorica/`).
...
Com as respostas de 4.3 e o acesso a `wiki/`, o passo seguinte é escrever os
