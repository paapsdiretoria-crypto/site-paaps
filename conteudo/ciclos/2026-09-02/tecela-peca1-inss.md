...
## A totalidade
O INSS é o núcleo do sistema de proteção social de quem trabalha no Brasil: a porta que confirma se o sofrimento de um trabalhador vira direito. Perdeu metade da capacidade de resposta exatamente quando o adoecimento mental ligado ao trabalho ficou mais visível no país inteiro. A resposta do Estado (pedido de concurso para 8.500 vagas em 2026) trata o problema como questão de RH, não como questão de como o trabalho é organizado.

## As mediações
1. A relação entre volume de processos e gente disponível é decidida politicamente, não natural do cargo.
2. Quando o quadro encolhe, o trabalho que sobra vira produção em ritmo de meta (mutirão), que aperta ainda mais quem ficou.
3. Ler todos os dias o relato documentado do sofrimento alheio, sem tempo de processamento nem suporte coletivo, é mediação psíquica concreta, não "trabalho estressante" genérico.
...
## Frase pronta (sem nome de autor)
"O INSS é quem decide, com carimbo, que o cansaço de um trabalhador brasileiro é real o suficiente para virar direito. É também um dos lugares dentro do próprio Estado onde esse cansaço mais aparece, e menos vira reconhecimento. Quem lê o sofrimento do país inteiro, todos os dias, também sofre, e ninguém carimba esse sofrimento."

## Créditos possíveis (fechamento, uma linha, nunca abertura)
Sofrimento ético-político (Sawaia) ou sofrimento social (Minayo).
...
- Fonte: https://apublica.org/2026/03/inss-perdeu-56-dos-servidores-e-lida-com-onda-de-burnout-enquanto-fila-de-pedidos-explode/

## Guardrails já respeitados
Nenhuma menção a regime jurídico (CLT/estatutário) nem à NR-1. Nenhuma sobreposição com Peça 2 (ACS) ou Peça 3 (envelhecimento). Nenhuma causalidade direta sem mediação. Todo dado com fonte rastreável.
