...
site/
  ...
  deploy-paaps-com-br/           ← só o LEIA-ME-DEPLOY.md, com o passo a passo de publicação
                                    no cPanel/HostGator. O pacote de subida é GERADO na hora a
                                    partir de home/, nunca mantido como cópia parada aqui.
```

**Insumos compartilhados:** logos, texturas e identidade visual ficam em `../../Acervo/` (identidade-visual/, aplicacao-id-visual/, fotos/); voz, critérios e identidade aplicada ficam em `../../Segundo Cérebro/Voz/Voz.md`.
