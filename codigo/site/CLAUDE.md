...
**Insumos compartilhados:** logos, texturas e identidade visual ficam em `../../Arquivos/` (identidade-visual/, aplicacao-id-visual/, fotos/); voz, critérios e identidade aplicada ficam em `../../Segundo Cérebro/Voz/Voz.md`.
