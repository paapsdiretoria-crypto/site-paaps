...
// Numeros fixos de exemplo. Na versao original da Midday estes valores vinham
// de server actions (GitHub API, banco de dados). Aqui sao so placeholders:
// troque pelos numeros reais da PAAPS quando o conteudo for escrito.
const stars = 3200;
const users = 1000;
