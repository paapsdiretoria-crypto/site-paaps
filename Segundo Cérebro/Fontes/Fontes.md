...
tags: [fontes, capa]
origem: "Sistema"
resumo: "O que veio de fora e dá para reconferir"
serve-para: []
status: vivo
...
Lei, dado oficial, estudo, notícia, aula, vídeo, livro e material de concorrente. Toda nota carrega link, órgão ou autor, data e o dado exato escrito por extenso.
...
- [[minerva-paaps-framework-notion]] : O Notion Minerva-paaps FrameWork descreve uma parceria pausada, ainda não representada no cofre, em que universitários da Minerva viveriam imersão na Refazenda Rio Xopotó para atuar dentro do PAAPS em Desterro do Melo
...
É a porta de entrada deste setor: quem procura alguma coisa aqui começa por esta nota.
