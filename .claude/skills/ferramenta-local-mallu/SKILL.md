...
O hook `Stop` já escreve em `Conhecimento/log/sessao-YYYY-MM-DD.md` e já commita. Mandar para o Notion **estende esse fluxo**, não cria um paralelo: leia o arquivo do dia e publique. Duas fontes de verdade para a mesma sessão é o começo de divergência silenciosa.
