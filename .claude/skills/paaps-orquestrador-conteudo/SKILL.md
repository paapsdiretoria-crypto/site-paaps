...
- **Passo 4. Âncora teórica (fundida com o passo 3).** Folhear a fonte densa (livro, artigo, dado), supra-entender o argumento inteiro antes de recortar, e então caçar frases-trampolim. Critério: a frase só entra se provocar reação própria na Mallu (concordância, contestação, ponte com território, SUS, servidor). Frase sem reação fica de fora.
