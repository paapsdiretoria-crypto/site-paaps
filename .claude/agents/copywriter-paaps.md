...
1. `Segundo Cérebro/Voz/Voz.md`: o gabarito de voz e as proibições ativas.
2. `Segundo Cérebro/Voz/Voz.md`: **os 8 modelos de slide e as 8
...
3. `Segundo Cérebro/Voz/Voz.md`: a primeira peça
...
3. `Segundo Cérebro/Método/Método.md`: você precisa **reconhecer** um
