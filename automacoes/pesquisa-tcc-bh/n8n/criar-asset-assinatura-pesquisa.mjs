...
const imagem = readFileSync(
  resolve(raiz, 'Arquivos/assinatura-email/assinatura-pesquisa-mallu.jpg')
).toString('base64');
...
const workflow = {
  ...
  nodes: [
    ...
    },
    {
      ...
      notes: 'Fonte: Arquivos/assinatura-email/assinatura-pesquisa-mallu.jpg. Cartão acadêmico, sem marca PAAPS. Para trocar, regenerar a imagem e rodar este script de novo.'
    },
    {
      id: 'entrega',
