...
3. **`wiki/voz-e-identidade/voz-paaps.md` é referenciado por caminho relativo** em
   `regras-prospeccao.md`, mas mora em `wiki/voz-e-identidade/` na raiz. O caminho não
   resolve daqui.
